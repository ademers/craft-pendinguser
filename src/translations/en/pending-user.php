...
return [
    ...
    'user_registered_heading' => 'Pending User plugin: when a new user registers',
    'user_registered_subject' => '{{siteName}}: User account created',
    'user_registered_body' => "Hi {{user.friendlyName}},\n\n" .
        "Your {{siteName}} user account {{user.username}} has been created and is pending activation.\n\n" .
        "You'll receive another email once we've reviewed and activated your account.\n\n",
    // User account activated by moderator
    'user_activated_heading' => 'Pending User plugin: when a user account is activated',
    'user_activated_subject' => '{{siteName}}: User account activated',
    'user_activated_body' => "Hi {{user.friendlyName}},\n\n" .
        "Your {{siteName}} user account {{user.username}} has been activated.\n\n",
    // Moderator email notification
    'moderator_notification_heading' => 'Pending User plugin: when the Moderator Email Notification setting is enabled',
    'moderator_notification_subject' => '{{siteName}}: User account activation request',
